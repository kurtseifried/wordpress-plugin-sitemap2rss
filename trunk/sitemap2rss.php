...
// Plugin constants
define('SITEMAP2RSS_VERSION', '1.0.10');
...
function sitemap2rss_load_textdomain() {
    load_plugin_textdomain('sitemap2rss', false, dirname(plugin_basename(__FILE__)) . '/languages');
}
add_action('plugins_loaded', 'sitemap2rss_load_textdomain');
